...
public class ExceptionsHandler {
    ...
    public ResponseEntity<ResponseDTO<BookDTO>> batRequestException(Exception e) {
        log.info(e.getMessage());
    ...
    public final ResponseEntity<ResponseDTO<BookDTO>> exceptionsGeneral(Exception e) {
    ...
    public final ResponseEntity<ResponseDTO<BookDTO>> exceptionsClientBadRequest(Exception e) {
        log.info(e.getClass().getName());
        log.error(e.getMessage());
