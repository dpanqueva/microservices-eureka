...
public class ExceptionsHandler {
    ...
    public ResponseEntity<ResponseDTO<ActorDTO>> batRequestException(Exception e) {
        log.info(e.getMessage());
    ...
    public final ResponseEntity<ResponseDTO<ActorDTO>> exceptionsGeneral(Exception e) {
    ...
    public final ResponseEntity<ResponseDTO<ActorDTO>> exceptionsClientBadRequest(Exception e) {
        log.info(e.getClass().getName());
        log.error(e.getMessage());
